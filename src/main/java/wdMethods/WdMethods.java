...
public interface WdMethods {
		...
		/**
		 * This method will fetch the current windowHandle and store it before switching to the new window
		 * @param winHandle
		 * @author Deepika - Student, TestLeaf
		 */
		public void getWinHandleBefore(String winHandle);
		
		/**
		 * This method will switch to the previous window if existing window is already closed
		 * @param winHandle
		 * @author Deepika - Student,TestLeaf
		 */
		public void switchToPreviousWindow(String winHandle);
